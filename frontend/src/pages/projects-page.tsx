...
export function ProjectsPage() {
  usePageMeta("Dự án", "Hồ sơ năng lực và công trình cơ khí, kết cấu thép, băng tải và hệ thống công nghiệp của DK Industry.")
